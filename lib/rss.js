...
function parseDate(str) { try { return new Date(str).getTime()||Date.now(); } catch { return Date.now(); } }
function getKeywords(title) {
  const stop = new Set(['ve','ile','bir','bu','da','de','den','için','olan','veya','ama','çok','en','mi','mu','mı','mü','ne','ki']);
